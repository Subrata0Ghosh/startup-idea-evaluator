...
class IdeaListScreen extends StatefulWidget {
  ...
  const IdeaListScreen({super.key, required this.onToggleTheme, required this.isDark});
              ...
              child: _ideas.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return IdeaCard(idea: idea, onUpvote: () => _upvote(index), onCopied: () { if (!mounted) return; ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Idea Copied!'))); });
                      },
                    ),
            ),
          ],
